...
public class RvGComplianceTests
{
    ...
    public void FMV_Bit_Coherency_Test()
    {
        ...
        var fmvIn = new AetherRISC.Core.Architecture.Hardware.ISA.Extensions.F.FmvWXInstruction(1, 1);
        fmvIn.Execute(_state, new InstructionData { Rd = 1, Rs1 = 1 });

        // 3. FMV.X.W (Move to X2)
        var fmvOut = new AetherRISC.Core.Architecture.Hardware.ISA.Extensions.F.FmvXWInstruction(2, 1);

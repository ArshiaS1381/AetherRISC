...
public class ZexthPseudo : IPseudoInstruction 
{ 
    public string Mnemonic => "ZEXT.H"; 
    public string Name => "Zero Extend Halfword";
    public string Description => "Zero-extends the lower 16 bits of rs1.";
    public string Usage => "zext.h rd, rs1";
    public IEnumerable<IInstruction> Expand(int rd, int rs1, int rs2, long imm) => [new ZextHInstruction(rd, rs1, 0)]; 
}

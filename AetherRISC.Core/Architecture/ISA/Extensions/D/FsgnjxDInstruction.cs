...
{
    public class FsgnjxDInstruction : Instruction {
        public override string Mnemonic => "FsgnjxD";
        public override int Rd { get; } public override int Rs1 { get; } public override int Rs2 { get; }
        public FsgnjxDInstruction(int rd, int rs1, int rs2) { Rd = rd; Rs1 = rs1; Rs2 = rs2; }

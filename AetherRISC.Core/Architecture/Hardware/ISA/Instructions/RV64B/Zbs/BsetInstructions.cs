...
[RiscvInstruction("BSET", InstructionSet.Zbs, RiscvEncodingType.R, 0x33, Funct3 = 1, Funct7 = 0x14,
    Name = "Bit Set",
    Description = "Sets a single bit in rs1 at the index specified by rs2.",
...
[RiscvInstruction("BSETI", InstructionSet.Zbs, RiscvEncodingType.ShiftImm, 0x13, Funct3 = 1, Funct6 = 0x0A,
    Name = "Bit Set Immediate",
    Description = "Sets a single bit in rs1 at the index specified by the immediate.",
    Usage = "bseti rd, rs1, shamt")]

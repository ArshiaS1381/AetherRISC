...
{
    public class FcvtSDInstruction : Instruction {
        public override string Mnemonic => "FcvtSD";
        public override int Rd { get; } public override int Rs1 { get; }
        public FcvtSDInstruction(int rd, int rs1) { Rd = rd; Rs1 = rs1; }
        
        public override void Execute(MachineState s, InstructionData d) {
            double v1 = s.FRegisters.ReadDouble(d.Rs1);
            float res = (float)((float)v1);

...
[RiscvInstruction("AMOAND.W", InstructionSet.RV64A, RiscvEncodingType.R, 0x2F, Funct3 = 2, Funct7 = 0x0C)]
public class AmoAndWInstruction : RTypeInstruction
{
    public AmoAndWInstruction(int rd, int rs1, int rs2) : base(rd, rs1, rs2) { }
...
[RiscvInstruction("AMOAND.D", InstructionSet.RV64A, RiscvEncodingType.R, 0x2F, Funct3 = 3, Funct7 = 0x0C)]
public class AmoAndDInstruction : RTypeInstruction
{
    public AmoAndDInstruction(int rd, int rs1, int rs2) : base(rd, rs1, rs2) { }
    public override void Execute(MachineState s, InstructionData d) {
        uint addr = (uint)s.Registers.Read(d.Rs1);

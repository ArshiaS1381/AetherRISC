...
namespace AetherRISC.Core.Architecture.ISA.Base {
    public class BeqInstruction : Instruction {
        ...
        // Simple Constructor (Generator picks this one)
        public BeqInstruction(int rs1, int rs2, int imm) : this(rs1, rs2, imm, 0) { }
        
        // Full Constructor
        public BeqInstruction(int rs1, int rs2, int imm, int funct3) { Rs1 = rs1; Rs2 = rs2; Imm = imm; Funct3 = funct3; }

...
{
    public class AmoOrInstruction : Instruction {
        public override string Mnemonic => IsWord ? "AMOOR.W" : "AMOOR.D";
        public override int Rd { get; } public override int Rs1 { get; } public override int Rs2 { get; }
        public bool IsWord { get; }
        public AmoOrInstruction(int rd, int rs1, int rs2, bool isWord) { Rd = rd; Rs1 = rs1; Rs2 = rs2; IsWord = isWord; }

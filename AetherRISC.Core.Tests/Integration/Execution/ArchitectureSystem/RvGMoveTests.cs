...
public class RvGMoveTests
{
    ...
    public void FMV_D_X_RoundTrip_PreservesBits()
    {
        ...
        // 2. FMV.D.X f1, x1
        var fmvTo = new AetherRISC.Core.Architecture.Hardware.ISA.Extensions.D.FmvDXInstruction(1, 1);
        fmvTo.Execute(_state, new InstructionData { Rd = 1, Rs1 = 1 });

        // 3. FMV.X.D x2, f1
        var fmvFrom = new AetherRISC.Core.Architecture.Hardware.ISA.Extensions.D.FmvXDInstruction(2, 1);

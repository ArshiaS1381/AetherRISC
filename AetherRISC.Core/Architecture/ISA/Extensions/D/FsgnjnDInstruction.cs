...
{
    public class FsgnjnDInstruction : Instruction {
        public override string Mnemonic => "FsgnjnD";
        public override int Rd { get; } public override int Rs1 { get; } public override int Rs2 { get; }
        public FsgnjnDInstruction(int rd, int rs1, int rs2) { Rd = rd; Rs1 = rs1; Rs2 = rs2; }
